...
return [
    ...
    'connections' => [
        ...
        'shard_1' => [
            ...
            'unix_socket' => env('DB_SHARD_1_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'shard_2' => [
            ...
            'unix_socket' => env('DB_SHARD_2_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'shard_3' => [
            ...
            'unix_socket' => env('DB_SHARD_3_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
