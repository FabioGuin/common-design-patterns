...
class OpenAIProvider implements AIModelInterface
{
    private string $name;
    ...
    {
        return $this->modelConfig['description'] ?? 'OpenAI Model';
    }
    ...
    public function generateImage(string $prompt, array $options = []): array
    {
        ...
        try {
            ...
            return [
                ...
                'provider' => $this->getProvider(),
                'duration' => $duration,
                'cost' => $this->modelConfig['cost_per_image'] ?? 0.040
            ];
    ...
    {
        $providerConfig = config('ai_models.providers.openai');
    ...
    /**
     * Effettua una richiesta all'API OpenAI
     */
