...
@section('title', 'Modifica Articolo: ' . $article->title)
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('articles.update', $article) }}" id="articleForm">
                    ...
                    <div class="mb-4">
                        ...
                        @enderror
                        <div class="form-text">
                            <span id="titleCount">{{ strlen($article->title) }}</span>/255 caratteri
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @enderror
                        <div class="form-text">
                            <span id="contentCount">{{ strlen($article->content) }}</span> caratteri (minimo 50)
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @enderror
                        <div class="form-text">
                            <span id="excerptCount">{{ strlen($article->excerpt) }}</span>/500 caratteri
                        </div>
                    </div>
                    ...
                    <div class="mb-4" id="publishedDateField" style="display: {{ $article->status === 'published' ? 'block' : 'none' }};">
                    ...
                    <div class="alert alert-info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <strong>Creato:</strong> {{ $article->created_at->format('d/m/Y H:i') }}<br>
                                <strong>Ultima modifica:</strong> {{ $article->updated_at->format('d/m/Y H:i') }}
                            </div>
                            <div class="col-md-6">
                                <strong>Autore originale:</strong> {{ $article->user->name }}<br>
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            <a href="{{ route('articles.show', $article) }}" class="btn btn-outline-secondary me-2">
