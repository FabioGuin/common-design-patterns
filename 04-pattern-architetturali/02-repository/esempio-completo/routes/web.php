...
Route::prefix('articles')->name('articles.')->group(function () {
    ...
    Route::get('author/{authorId}', [ArticleController::class, 'byAuthor'])->name('by-author');
...
Route::get('/dashboard', function () {
    $articleStats = app(\App\Services\ArticleService::class)->getArticleStats();
    $userStats = app(\App\Services\UserService::class)->getUserStats();
